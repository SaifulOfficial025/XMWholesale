      ...
      <div className="bg-white min-h-screen py-8 px-2 md:px-8">
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2">
            <div className="bg-white rounded-xl shadow p-6 flex flex-col md:flex-row items-center md:items-start gap-6 border relative">
              <button
              ...
              <div className="flex-1 flex flex-col gap-2">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between w-full">
                  <h2 className="text-base md:text-xl font-semibold mb-1 md:mb-0">
                    ...
                    <br className="md:hidden" /> 4X4 COMPARTMENT
                  </h2>
                ...
                <div className="mt-2 text-base">
                  ...
                  <span className="ml-2 font-bold text-base md:text-lg">5</span>
          ...
          <div>
            <div className="bg-white rounded-xl shadow p-6 border flex flex-col gap-4">
              ...
              <button className="bg-[#c0121a] text-white font-semibold px-6 py-3 rounded shadow hover:bg-[#a70c17] transition mt-2 w-full md:w-auto text-center">
                Confirm Order
              </button>
            </div>
          </div>
